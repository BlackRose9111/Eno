...
namespace Eno.Controllers
{
    public class FilmsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PublishDate")] Films films)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PublishDate")] Films film)
        {
            if (id != film.Id)
            {
                return NotFound();
